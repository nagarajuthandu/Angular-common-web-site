...
@Component({
  selector: 'app-admin-cards-widget',
  templateUrl: './admin-cards-widget.component.html',
  styleUrls: ['./admin-cards-widget.component.css']
})
export class AdminCardsWidgetComponent {
  services: any;
  contents:any[]=[];
