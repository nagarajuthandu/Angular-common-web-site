...
@Component({
  selector: 'app-admin-carousel-widget',
  templateUrl: './admin-carousel-widget.component.html',
  styleUrls: ['./admin-carousel-widget.component.css']
})
export class AdminCarouselWidgetComponent implements OnInit {
  services: any;
  contents:any[]=[];
